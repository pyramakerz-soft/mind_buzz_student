                  ...
                  if (state is GetReportsLoadingInitial) {
                    ...
                    return Column(
                      ...
                      children: [
                            ...
                            children: List.generate(
                                state.data.testTypes?.length??0,
                                    ...
                                    Row(
                                      children: [
                                        ItemSelected(
                                          itemId: "${state.data.testTypes?[index].id??0}",
                                          title: "${state.data.testTypes?[index].name??0}",
                                          currentItemSelected:
                                          ...
                                          onTap: () {
                                            context
                                                ...
                                                .submitNewType(
                                                newType: "${state.data.testTypes?[index].id??0}");
                                          },
                                        ),
                                        5.pw,
                                      ],
                        ...
                        10.ph,
                         Column(
                              children: List.generate(state.data.progress?.length??0, (index) => Column(
                                children: [
                                  CardReport(
                                      // isPassed: false,
                                      data:state.data.progress?[index]??TestModel()
                                  ),
                                  10.ph
                                ],
                              )),
