...
class LoginScreen extends StatelessWidget {
  ...
  final TextEditingController _emailController = TextEditingController(text: kDebugMode ? 'sherif@test.com' : '');
  final TextEditingController _passwordController = TextEditingController(text: kDebugMode ? '123456' : '');
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  @override
  Widget build(BuildContext context) {
    final showPassword = context.select((LoginCubit value) => value.state.showPassword) ?? true;
    return Scaffold(
        body: Container(
                  ...
                  child: SingleChildScrollView(
                    child: Form(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                        ...
                        TextFieldWidget(
                            ...
                            onChanged: (val) {
                              if (_emailController.text.isNotEmpty && _passwordController.text.isNotEmpty) {
                                context.read<LoginCubit>().updateDisableButton(supState: true);
                              } else {
                                context.read<LoginCubit>().updateDisableButton(supState: false);
                              }
                            }),
                        16.ph,
                        TextFieldWidget(
                            ...
                            rightWidget: IconButton(
                              onPressed: () {
                                context.read<LoginCubit>().updateTheShowPassword();
                              },
                              icon: Icon(
                                showPassword == true ? CupertinoIcons.eye_fill : CupertinoIcons.eye_slash_fill,
                                color: Colors.grey,
                              ),
                            ),
                            onChanged: (val) {
                        ...
                        40.ph,
                        BlocConsumer<LoginDataBloc, LoginDataState>(listener: (context, state) {
                          log('##state:$state');
                          if (state is ErrorLogin) {
                            ...
                            Utils.navigateAndRemoveUntilTo(const WhoAmIScreen(), context);
                          }
                            ...
                            return BlocConsumer<LoginCubit, LoginStateInitial>(
                                ...
                                builder: (context, supLoginState) {
                                  return ButtonLogin(
                                    ...
                                    fontSize: 35,
                                    playButton: supLoginState.disableButton == null ? true : (supLoginState.disableButton),
                                    ...
                                    dataFunction: () {
                                      ...
                                      context.read<LoginDataBloc>().add(LoginRequest(email: _emailController.text, password: _passwordController.text));
                                    },
                                    title: "Log In",
