                  ...
                  Container(
                      ...
                      child: DragTarget<GameImagesModel>(builder: (
                        ...
                        if (item.data.word
                                ...
                                .first
                                .toLowerCase() !=
                            (gameState.gameData[gameState.index??0].mainLetter?.toLowerCase() ?? '')) {
                          await context
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: List.generate(
                          gameState.gameData[gameState.index??0].gameImages?.length ?? 0,
                          (index) => Draggable<GameImagesModel>(
                              data: gameState.gameData[gameState.index??0].gameImages?[index],
                              ...
                              feedback: CachedNetworkImage(
                                imageUrl:
                                gameState.gameData[gameState.index??0].gameImages?[index].image ?? '',
                                width: (MediaQuery.of(context).size.width -
                                        (130 + 50 + 130)) /
                                    4,
                                height: 130.h,
                              ...
                              child: ((stateOfCurrentGamePhoneticsCubit
                                              .stateOfAvatar ==
                                          BasicOfEveryGame.stateOfWin) &&
                                      (gameState.gameData[gameState.index??0].gameImages?[index].word
                                              .toString()
                                              .split('')
                                              .first
                                              .toLowerCase() !=
                                  ...
                                  : GestureDetector(
                                      onTap: () {
                                        TalkTts.startTalk(
                                            text: gameState.gameData[gameState.index??0]
