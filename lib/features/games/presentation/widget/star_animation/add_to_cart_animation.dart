...
class AddToCartAnimation extends StatefulWidget {
  ...
  final Function(Future<void> Function(GlobalKey, Container actionWidget))
  ...
  State<StatefulWidget> createState() {
    return _AddToCartAnimationState();
  }
...
class _AddToCartAnimationState extends State<AddToCartAnimation> {
  ...
  Future<void> runAddToCartAnimation(
      GlobalKey widgetKey, Container actionWidget) async {
