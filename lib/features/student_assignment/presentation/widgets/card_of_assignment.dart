...
class CardOfAssignment extends StatelessWidget{
  ...
  const CardOfAssignment({Key? key, required this.assignmentTask}) : super(key: key);
  @override
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Column(
              children: [
                Text(assignmentTask.program?.course?.name??'', style: Theme.of(context).textTheme.displayLarge?.copyWith(
                  fontSize: 22,
