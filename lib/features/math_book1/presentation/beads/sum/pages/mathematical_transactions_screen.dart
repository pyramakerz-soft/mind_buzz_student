...
class MathematicalTransactionsScreen extends StatelessWidget {
  ...
  const MathematicalTransactionsScreen({Key? key, required this.defaultActionOfSuccessAnswer, required this.defaultActionOfWrongAnswer})
      : super(key: key);
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                    await context.read<BeadsSumMcqCubit>().checkCorrect(
                                        actionOfSuccess:()=>defaultActionOfSuccessAnswer(),
