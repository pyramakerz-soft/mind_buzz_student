...
class ItemOfTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (chapterData.isCheckPoint == true) {
        ...
        return Text('CheckPoint', style: Theme.of(context).textTheme.displayMedium?.copyWith(fontSize: 16, fontWeight: FontWeight.w600),);

    } else if (chapterData.isAssessment == true) {
      return Text('Assessment', style: Theme.of(context).textTheme.displayMedium?.copyWith(fontSize: 16, fontWeight: FontWeight.w600),);
